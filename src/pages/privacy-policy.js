...
export default function Index() {
	return (
		<Layout>
			<article className="space-y-6 container mx-auto my-10">
...
CyberflixOfficial.com ("us", "we", or "our") operates the [wpautoterms site_name] website (the "Service").
<br />
<br />
...
<h2>Contact Us</h2>
If you have any questions about this Privacy Policy, please <a className="link" href="/contact">contact us</a>.
